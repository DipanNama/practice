...
const ProductDetail = () => {
    ...
    // const totalCartItem = allNumbers.reduce((partialSum, a) => partialSum + parseInt(a), 0)
                    ...
                    < div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 " >
                        <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                            <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                                <p className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600">Home / {data.category} / {data.productName}</p>
                                <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-4">{data.productName}</h2>
                                ...
                                <p className=" font-normal text-base leading-6 text-gray-600 mt-7">{data.desc}</p>
                        ...
                        <div className="flex  justify-center items-center w-full">
                            <div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10">
                                <div>
                                    ...
                                    <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">Size</p>
                                    <p className="text-normal text-base  uppercase font-bold  leading-6 text-gray-600 mt-4">{data.size}</p>
                                </div>
                                <div>
                                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">Colour</p>
                                    <p className={`text-normal text-base uppercase font-bold leading-6 text-${data.colour}-600 mt-4`}>{data.colour}</p>
                                </div>
                                <div>
                                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">Brand</p>
                                    <p className="text-normal text-base  uppercase font-bold  leading-6 text-gray-600 mt-4">{data.brand}</p>
                                </div>
                                <div>
                                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
